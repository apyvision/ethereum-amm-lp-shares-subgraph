...
export class Pair__virtualBalancesForAdditionResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pair__virtualBalancesForRemovalResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pair__virtualDecayPeriodResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Pair__virtualFeeResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Pair__virtualSlippageFeeResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Pair__volumesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pair extends ethereum.SmartContract {
  ...
  virtualBalancesForAddition(
    param0: Address
  ): Pair__virtualBalancesForAdditionResult {
    let result = super.call(
      "virtualBalancesForAddition",
    ...
    return new Pair__virtualBalancesForAdditionResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_virtualBalancesForAddition(
    param0: Address
  ): ethereum.CallResult<Pair__virtualBalancesForAdditionResult> {
    let result = super.tryCall(
      "virtualBalancesForAddition",
      "virtualBalancesForAddition(address):(uint216,uint40)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Pair__virtualBalancesForAdditionResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  virtualBalancesForRemoval(
    param0: Address
  ): Pair__virtualBalancesForRemovalResult {
    let result = super.call(
      "virtualBalancesForRemoval",
    ...
    return new Pair__virtualBalancesForRemovalResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_virtualBalancesForRemoval(
    param0: Address
  ): ethereum.CallResult<Pair__virtualBalancesForRemovalResult> {
    let result = super.tryCall(
      "virtualBalancesForRemoval",
      "virtualBalancesForRemoval(address):(uint216,uint40)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pair__virtualBalancesForRemovalResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  virtualDecayPeriod(): Pair__virtualDecayPeriodResult {
    let result = super.call(
      "virtualDecayPeriod",
    ...
    return new Pair__virtualDecayPeriodResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualDecayPeriod(): ethereum.CallResult<
    Pair__virtualDecayPeriodResult
  > {
    let result = super.tryCall(
      "virtualDecayPeriod",
      "virtualDecayPeriod():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pair__virtualDecayPeriodResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  virtualFee(): Pair__virtualFeeResult {
    let result = super.call(
      "virtualFee",
    ...
    return new Pair__virtualFeeResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualFee(): ethereum.CallResult<Pair__virtualFeeResult> {
    let result = super.tryCall(
      "virtualFee",
      "virtualFee():(uint104,uint104,uint48)",
      []
  ...
  virtualSlippageFee(): Pair__virtualSlippageFeeResult {
    let result = super.call(
      "virtualSlippageFee",
    ...
    return new Pair__virtualSlippageFeeResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualSlippageFee(): ethereum.CallResult<
    Pair__virtualSlippageFeeResult
  > {
    let result = super.tryCall(
      "virtualSlippageFee",
      "virtualSlippageFee():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pair__virtualSlippageFeeResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  volumes(param0: Address): Pair__volumesResult {
    let result = super.call("volumes", "volumes(address):(uint128,uint128)", [
      ethereum.Value.fromAddress(param0)
    ]);

    return new Pair__volumesResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_volumes(param0: Address): ethereum.CallResult<Pair__volumesResult> {
    let result = super.tryCall(
      "volumes",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pair__volumesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
