...
export class Factory__defaultsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Factory__shareParametersResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
  value3: Address;
...
export class Factory__virtualDefaultDecayPeriodResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Factory__virtualDefaultFeeResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Factory__virtualDefaultSlippageFeeResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Factory__virtualGovernanceShareResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Factory__virtualReferralShareResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Factory extends ethereum.SmartContract {
  ...
  defaults(): Factory__defaultsResult {
    let result = super.call(
      "defaults",
    ...
    return new Factory__defaultsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_defaults(): ethereum.CallResult<Factory__defaultsResult> {
    let result = super.tryCall(
      "defaults",
      "defaults():(uint256,uint256,uint256)",
      []
  ...
  shareParameters(): Factory__shareParametersResult {
    let result = super.call(
      "shareParameters",
    ...
    return new Factory__shareParametersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toAddress()
  ...
  try_shareParameters(): ethereum.CallResult<Factory__shareParametersResult> {
    let result = super.tryCall(
      "shareParameters",
      "shareParameters():(uint256,uint256,address,address)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Factory__shareParametersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toAddress()
  ...
  virtualDefaultDecayPeriod(): Factory__virtualDefaultDecayPeriodResult {
    let result = super.call(
    ...
    return new Factory__virtualDefaultDecayPeriodResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualDefaultDecayPeriod(): ethereum.CallResult<
    Factory__virtualDefaultDecayPeriodResult
  > {
    let result = super.tryCall(
      "virtualDefaultDecayPeriod",
      "virtualDefaultDecayPeriod():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Factory__virtualDefaultDecayPeriodResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  virtualDefaultFee(): Factory__virtualDefaultFeeResult {
    let result = super.call(
      "virtualDefaultFee",
    ...
    return new Factory__virtualDefaultFeeResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualDefaultFee(): ethereum.CallResult<
    Factory__virtualDefaultFeeResult
  > {
    let result = super.tryCall(
      "virtualDefaultFee",
      "virtualDefaultFee():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Factory__virtualDefaultFeeResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  virtualDefaultSlippageFee(): Factory__virtualDefaultSlippageFeeResult {
    let result = super.call(
    ...
    return new Factory__virtualDefaultSlippageFeeResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualDefaultSlippageFee(): ethereum.CallResult<
    Factory__virtualDefaultSlippageFeeResult
  > {
    let result = super.tryCall(
      "virtualDefaultSlippageFee",
      "virtualDefaultSlippageFee():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Factory__virtualDefaultSlippageFeeResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  virtualGovernanceShare(): Factory__virtualGovernanceShareResult {
    let result = super.call(
    ...
    return new Factory__virtualGovernanceShareResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualGovernanceShare(): ethereum.CallResult<
    Factory__virtualGovernanceShareResult
  > {
    let result = super.tryCall(
      "virtualGovernanceShare",
      "virtualGovernanceShare():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Factory__virtualGovernanceShareResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  virtualReferralShare(): Factory__virtualReferralShareResult {
    let result = super.call(
    ...
    return new Factory__virtualReferralShareResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_virtualReferralShare(): ethereum.CallResult<
    Factory__virtualReferralShareResult
  > {
    let result = super.tryCall(
      "virtualReferralShare",
      "virtualReferralShare():(uint104,uint104,uint48)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Factory__virtualReferralShareResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
